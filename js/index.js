...
/*draw my language pie */

var myColor = ["#39ca74","#e54d42","#f0c330","#3999d8","#35485d", "#924799"];
var myData = [30,28,15,10,30,30];
var myLabel = ["Java","JavaScript","Python","C","HTML5","CSS3"];
...
function plotData() {
  ...
  var doc;
  canvas = document.getElementById("language-pie");
  ...
  for (var i = 0; i < myData.length; i++) {
    ...
    ctx.fillText(myLabel[i], end[0]+textOffset,end[1]-4); 
    // Increment Loop
